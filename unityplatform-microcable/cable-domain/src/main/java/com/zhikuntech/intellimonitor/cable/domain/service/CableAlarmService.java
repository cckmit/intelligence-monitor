...
public interface CableAlarmService {
    ...
    List<CableTemperatureAlarmDTO> getAlarmTemperature(CableIdQuery query) throws Exception;
     ...
     */
    List<CableTemperatureAlarmDTO> getAlarmAllTemperature(CableIdQuery query) throws Exception;
     ...
     */
    List<CableStressAlarmDTO> getAlarmStress(CableIdQuery query) throws Exception;
     ...
     * @return 一条海缆的报警时间 所有点位的温度数据
     */
    List<CableStressAlarmDTO> getAlarmAllStress(CableIdQuery query) throws Exception;
}
