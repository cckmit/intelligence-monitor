...
public enum ResultCode {
    ...
    NULL_POINTER_EXCEPTION(HttpConstant.NULL_POINTER_EXCEPTION,"空指针异常"),
    ARRAY_INDEX_OUT_OF_BOUNDS_EXCEPTION(HttpConstant.ARRAY_INDEX_OUT_OF_BOUNDS_EXCEPTION,"数组角标越界异常"),
    CLASS_CAST_EXCEPTION(HttpConstant.CLASS_CAST_EXCEPTION,"类转换异常"),
    SQL_EXCEPTION(HttpConstant.SQL_EXCEPTION,"数据库异常"),
    ARITHMETIC_EXCEPTION(HttpConstant.ARITHMETIC_EXCEPTION,"算数计算异常"),
    ILLEGAL_ARGUMENT_EXCEPTION(HttpConstant.ILLEGAL_ARGUMENT_EXCEPTION,"非法参数异常"),
    ILLEGAL_ACCESS_EXCEPTION(HttpConstant.ILLEGAL_ACCESS_EXCEPTION,"非法权限异常"),
    STACK_OVER_FLOW_ERROR(HttpConstant.STACK_OVER_FLOW_ERROR,"栈溢出"),
    ILLEGAL_STATE_EXCEPTION(HttpConstant.ILLEGAL_STATE_EXCEPTION,"非法状态异常"),
    PARAMETERS_CALIBRATION_FAILURE(HttpConstant.PARAMETERS_CALIBRATION_FAILURE,"参数校验失败");
    ;
